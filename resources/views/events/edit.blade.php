...
@section('content')
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <form class="p-6 space-y-6" method="POST" action="{{ route('events.update', $event->id) }}"
                ...
                <div>
                    ...
                    <select id="type" name="type"
                        ...
                        <option value="virtual" {{ old('type', $event->type) == 'virtual' ? 'selected' : '' }}>Virtual
                        </option>
                ...
                <div>
                    ...
                    @if($event->logo)
                        <div class="mb-3">
                            <img src="{{ asset('storage/logos/' . $event->logo) }}" alt="Current Logo"
                ...
                <div>
                    ...
                    <input type="url" id="banner_url" name="banner_url" value="{{ old('banner_url', $event->banner_url) }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $event->email) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" name="phone" value="{{ old('phone', $event->phone) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
