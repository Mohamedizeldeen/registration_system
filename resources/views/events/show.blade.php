        ...
        <div class="max-w-6xl mx-auto px-4 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="{{ route('events.edit', $event->id) }}" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition duration-200 flex items-center">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center space-x-4">
                            <img src="{{ asset('storage/logos/' . $event->logo) }}" alt="{{ $event->name }}" class="h-20 w-20 object-cover rounded-lg">
                            <div>
                        ...
                        <div>
                            ...
                            <img src="{{ $event->banner_url }}" alt="Event Banner" class="w-full h-64 object-cover rounded-lg">
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <a href="mailto:{{ $event->email }}" class="text-blue-600 hover:text-blue-800">{{ $event->email }}</a>
                        </div>
                        @endif
                        @if($event->phone)
                        <div class="flex items-center space-x-3">
                            <i class="fas fa-phone text-gray-400"></i>
                            <a href="tel:{{ $event->phone }}" class="text-blue-600 hover:text-blue-800">{{ $event->phone }}</a>
                        </div>
                        @endif
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-3">
                        <a href="{{ route('eventZones.create') }}?event_id={{ $event->id }}" class="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition duration-200 flex items-center justify-center">
                            <i class="fas fa-plus mr-2"></i>Add Zone
                        </a>
                        <a href="{{ route('tickets.create') }}?event_id={{ $event->id }}" class="w-full px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md transition duration-200 flex items-center justify-center">
                            <i class="fas fa-ticket-alt mr-2"></i>Add Tickets
                        </a>
                        <a href="{{ route('attendees.index') }}?event_id={{ $event->id }}" class="w-full px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-md transition duration-200 flex items-center justify-center">
                            <i class="fas fa-users mr-2"></i>View Attendees
                        </a>
                        <a href="{{ route('events.edit', $event->id) }}" class="w-full px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-md transition duration-200 flex items-center justify-center">
                            <i class="fas fa-edit mr-2"></i>Edit Event
                        </a>
                    </div>
                </div>
