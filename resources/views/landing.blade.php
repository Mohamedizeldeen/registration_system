    ...
    <nav class="fixed w-full z-50 transition-all duration-500 bg-white/80 backdrop-blur-md border-b border-white/20" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8 scroll-reveal">
                    ...
                    <a href="{{ route('public.events') }}" class="btn-primary text-white px-6 py-2 rounded-full font-medium relative z-10 pulse-glow">
                        Browse Events
                    </a>
                    
                    @auth
                        @if(auth()->user()->role === 'super_admin')
                            <a href="{{ route('dashboard') }}" class="btn-primary text-white px-6 py-2 rounded-full font-medium relative z-10">
                        ...
                        @elseif(auth()->user()->role === 'admin' || auth()->user()->role === 'company_admin')
                            <a href="{{ route('company-admin.dashboard') }}" class="btn-primary text-white px-6 py-2 rounded-full font-medium relative z-10">
                                <span class="relative z-10"><i class="fas fa-tachometer-alt mr-2"></i>Dashboard</span>
                            </a>
                        @elseif(auth()->user()->role === 'organizer' || auth()->user()->role === 'company_organizer')
                            <a href="{{ route('company-organizer.dashboard') }}" class="btn-primary text-white px-6 py-2 rounded-full font-medium relative z-10">
                                <span class="relative z-10"><i class="fas fa-tachometer-alt mr-2"></i>Dashboard</span>
                            </a>
                        @endif
                    @else
                        <a href="{{ route('login') }}" class="btn-primary text-white px-6 py-2 rounded-full font-medium relative z-10">
        ...
        <div id="mobile-menu" class="md:hidden hidden glass-dark border-t border-white/10">
            <div class="px-4 py-4 space-y-3">
                ...
                <a href="{{ route('public.events') }}" class="block btn-primary text-white px-4 py-2 rounded-full font-medium text-center">
                    Browse Events
                </a>
                
                @auth
                    @if(auth()->user()->role === 'super_admin')
                        <a href="{{ route('dashboard') }}" class="block btn-primary text-white px-4 py-2 rounded-full font-medium text-center">
                            <i class="fas fa-tachometer-alt mr-2"></i>Dashboard
                        </a>
                    @elseif(auth()->user()->role === 'admin' || auth()->user()->role === 'company_admin')
                        <a href="{{ route('company-admin.dashboard') }}" class="block btn-primary text-white px-4 py-2 rounded-full font-medium text-center">
                            <i class="fas fa-tachometer-alt mr-2"></i>Dashboard
                        </a>
                    @elseif(auth()->user()->role === 'organizer' || auth()->user()->role === 'company_organizer')
                        <a href="{{ route('company-organizer.dashboard') }}" class="block btn-primary text-white px-4 py-2 rounded-full font-medium text-center">
                            <i class="fas fa-tachometer-alt mr-2"></i>Dashboard
                        </a>
                    @endif
                @else
                    <a href="{{ route('login') }}" class="block btn-primary text-white px-4 py-2 rounded-full font-medium text-center">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <div class="scroll-reveal">
                ...
                <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
                    <a href="{{ route('public.events') }}" class="group btn-primary text-white px-10 py-5 rounded-full font-bold text-lg pulse-glow">
                    ...
                    @auth
                        @if(auth()->user()->role === 'super_admin')
                            <a href="{{ route('dashboard') }}" class="group glass border border-white/30 text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-white/10 transition-all duration-300">
                        ...
                        @elseif(auth()->user()->role === 'admin' || auth()->user()->role === 'company_admin')
                            <a href="{{ route('company-admin.dashboard') }}" class="group glass border border-white/30 text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-white/10 transition-all duration-300">
                                <span class="flex items-center">
                                    <i class="fas fa-tachometer-alt mr-3 group-hover:scale-110 transition-transform duration-300"></i>
                                    Dashboard
                                </span>
                        ...
                        @elseif(auth()->user()->role === 'organizer' || auth()->user()->role === 'company_organizer')
                            <a href="{{ route('company-organizer.dashboard') }}" class="group glass border border-white/30 text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-white/10 transition-all duration-300">
                                <span class="flex items-center">
                                    <i class="fas fa-tachometer-alt mr-3 group-hover:scale-110 transition-transform duration-300"></i>
                                    Dashboard
                                </span>
                        ...
                        @endif
                    @else
                        <a href="{{ route('login') }}" class="group glass border border-white/30 text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-white/10 transition-all duration-300">
                            <span class="flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="{{ route('public.events') }}" class="text-gray-400 hover:text-white transition-colors duration-300 text-lg font-medium flex items-center">
                            <i class="fas fa-chevron-right mr-3 text-blue-400 text-sm"></i>Browse Events</a></li>
                        @guest
                            <li><a href="{{ route('login') }}" class="text-gray-400 hover:text-white transition-colors duration-300 text-lg font-medium flex items-center">
