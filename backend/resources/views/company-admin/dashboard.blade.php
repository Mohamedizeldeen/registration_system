...
@section('content')
    ...
    <main class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Company Admin Dashboard - {{ auth()->user()->name}}</p>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ number_format($totalZones) }}</p>
                    </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 mb-4 last:mb-0">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">{{ Str::limit($event->description, 80) }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('company-admin.payments') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View All Payments</a>
            </div>
            ...
            @forelse($recentPayments as $payment)
                <div class="flex items-center justify-between py-3 border-b border-gray-100 last:border-b-0">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="font-medium text-gray-900">{{ $payment->attendee->user->name ?? 'Unknown' }}</p>
                            <p class="text-sm text-gray-500">{{ $payment->attendee->event->name ?? 'Unknown Event' }}</p>
                        </div>
                    </div>
                    <div class="text-right">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('company-admin.events') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View All Events</a>
            </div>
                            ...
                            <tr class="border-b border-gray-100">
                                ...
                                <td class="py-4 text-right">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('events.show', $event) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View</a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <a href="{{ route('company-admin.events') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700">
                    Manage Events
                </a>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route('tickets.create') }}" class="inline-flex items-center px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 w-full justify-center">
                        Create Ticket
                    </a>
                    <a href="{{ route('tickets.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 w-full justify-center">
                        View All Tickets
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route('eventZones.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 w-full justify-center">
                        Create Zone
                    </a>
                    <a href="{{ route('eventZones.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 w-full justify-center">
                        View All Zones
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <a href="{{ route('company-admin.attendees') }}" class="inline-flex items-center px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-lg hover:bg-purple-700">
                    View Attendees
                </a>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="{{ route('company-admin.test-qr') }}" target="_blank" class="bg-white border border-blue-200 rounded-lg p-4 hover:bg-blue-50 transition-colors">
                    <div class="flex items-center">
                ...
                <a href="{{ route('company-admin.test-pdf') }}" target="_blank" class="bg-white border border-blue-200 rounded-lg p-4 hover:bg-blue-50 transition-colors">
                    <div class="flex items-center">
                ...
                <a href="{{ route('company-admin.print-tickets.form') }}" class="bg-white border border-blue-200 rounded-lg p-4 hover:bg-blue-50 transition-colors">
                    <div class="flex items-center">
