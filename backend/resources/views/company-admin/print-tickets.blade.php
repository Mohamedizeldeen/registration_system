...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('company-admin.attendees') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg flex items-center">
        ...
        <div class="bg-gray-50 rounded-lg p-6 mb-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <form method="GET" action="{{ route('company-admin.print-tickets.form') }}" class="space-y-3">
                        <div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6 mb-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('company-admin.print-tickets.form') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                    Clear Search
                </a>
            </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                    <div class="space-y-3">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <form method="POST" action="{{ route('company-admin.print-tickets') }}" class="flex-1" target="_blank">
                                @csrf
        ...
        <div class="text-center py-12">
            ...
            <a href="{{ route('company-admin.print-tickets.form') }}" class="text-blue-600 hover:text-blue-800 font-medium">
                Clear Search
            </a>
        </div>
        ...
        <form method="GET" action="{{ route('company-admin.print-tickets.form') }}" class="mb-6">
        ...
        <!-- Attendees Selection -->
        <form method="POST" action="{{ route('company-admin.print-tickets') }}" target="_blank">
            @csrf
...
function onScanSuccess(decodedText, decodedResult) {
    ...
    if (!isNaN(attendeeId) && attendeeId > 0) {
        ...
        window.open(`{{ url('company-admin/quick-print') }}/${attendeeId}`, '_blank');
    } else {
