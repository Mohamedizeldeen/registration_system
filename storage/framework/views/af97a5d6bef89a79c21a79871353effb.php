    ...
    <div class="bg-white shadow-sm">
        <div class="max-w-6xl mx-auto px-4 py-6">
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(route('tickets.create')); ?>" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition duration-200 flex items-center">
    ...
    <div class="max-w-6xl mx-auto px-4 py-4">
        <div class="bg-white rounded-lg shadow-sm p-4 flex flex-wrap gap-4 items-center">
            ...
            <select class="px-3 py-1 border border-gray-300 rounded-md text-sm">
                ...
                <?php $__currentLoopData = $allEventswithCompany; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <?php if(isset($tickets) && $tickets->count() > 0): ?>
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900"><?php echo e($ticket->type); ?></h3>
                                        <p class="text-sm text-gray-600"><?php echo e($ticket->event->name ?? 'Event Name'); ?></p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <div class="text-2xl font-bold text-blue-600"><?php echo e($ticket->currency->symbol ?? '$'); ?> <?php echo e(number_format($ticket->price, 2)); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-3 mb-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-semibold"><?php echo e($ticket->eventZone->name ?? 'Zone Name'); ?></span>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-semibold"><?php echo e(number_format($ticket->quantity)); ?></span>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-semibold text-green-600"><?php echo e($ticket->sold ?? 0); ?></span>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-semibold"><?php echo e($ticket->quantity - ($ticket->sold ?? 0)); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span class="text-sm font-semibold">
                                        <?php echo e(round((($ticket->quantity - ($ticket->sold ?? 0)) / $ticket->quantity) * 100)); ?>% available
                                    </span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-gradient-to-r from-green-500 to-blue-600 h-2 rounded-full" 
                                         style="width: <?php echo e((($ticket->quantity - ($ticket->sold ?? 0)) / $ticket->quantity) * 100); ?>%"></div>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-between items-center">
                                <div class="text-xs text-gray-500">
                                    Created <?php echo e($ticket->created_at->diffForHumans() ?? '2 days ago'); ?>

                                </div>
                                
                                <div class="flex space-x-2">
                                    <a href="<?php echo e(route('tickets.show', $ticket->id)); ?>" class="text-blue-600 hover:text-blue-800">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('tickets.edit', $ticket->id)); ?>" class="text-yellow-600 hover:text-yellow-800">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="<?php echo e(route('tickets.destroy', $ticket->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this ticket?')">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="bg-white rounded-lg shadow-md p-6 text-center">
                    <div class="text-3xl font-bold text-blue-600"><?php echo e($tickets->count()); ?></div>
                    <div class="text-gray-600 mt-1">Total Tickets</div>
                </div>
                <div class="bg-white rounded-lg shadow-md p-6 text-center">
                    <div class="text-3xl font-bold text-green-600"><?php echo e($ticket->currency->symbol ?? '$'); ?> <?php echo e(number_format($tickets->sum('price'), 0)); ?></div>
                    <div class="text-gray-600 mt-1">Total Value</div>
                </div>
                <div class="bg-white rounded-lg shadow-md p-6 text-center">
                    <div class="text-3xl font-bold text-purple-600"><?php echo e(number_format($tickets->sum('quantity'))); ?></div>
                    <div class="text-gray-600 mt-1">Total Quantity</div>
                </div>
                <div class="bg-white rounded-lg shadow-md p-6 text-center">
                    <div class="text-3xl font-bold text-orange-600"><?php echo e($ticket->currency->symbol ?? '$'); ?> <?php echo e(number_format($tickets->avg('price'), 0)); ?></div>
        ...
        <?php else: ?>
            ...
            <div class="bg-white rounded-lg shadow-md p-12 text-center">
                ...
                <a href="<?php echo e(route('tickets.create')); ?>" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition duration-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\registration_system\resources\views/ticket/index.blade.php ENDPATH**/ ?>