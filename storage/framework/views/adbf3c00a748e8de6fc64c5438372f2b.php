<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white shadow-sm">
        <div class="max-w-4xl mx-auto px-4 py-6">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('eventZones.show', $eventZone->id ?? 1)); ?>" class="text-blue-600 hover:text-blue-800">
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-md">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-xl font-semibold text-gray-900">
                            <?php echo e($eventZone->name ?? 'VIP Section'); ?>

                        </h2>
                        <p class="text-gray-600">
                            Current capacity: <?php echo e(number_format($eventZone->capacity ?? 100)); ?> •
                            Event: <?php echo e($eventZone->event->name ?? 'Tech Conference 2024'); ?>
            ...
            <!-- Form -->
            <form action="<?php echo e(route('eventZones.update', $eventZone->id ?? 1)); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input type="text" id="name" name="name"
                            value="<?php echo e(old('name', $eventZone->name ?? 'VIP Section')); ?>" required
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input type="number" id="capacity" name="capacity"
                            value="<?php echo e(old('capacity', $eventZone->capacity ?? 100)); ?>" required min="1"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                            placeholder="Maximum number of attendees">
                        <p class="text-xs text-gray-500 mt-1">
                            <i class="fas fa-info-circle mr-1"></i>
                            Current occupancy: <?php echo e($eventZone->tickets_sold ?? 45); ?>/<?php echo e($eventZone->capacity ?? 100); ?>
                    ...
                    <select id="event_id" name="event_id" required
                        ...
                        <?php if(isset($events)): ?>
                            <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($event->id); ?>" <?php echo e(old('event_id', $eventZone->event_id ?? 1) == $event->id ? 'selected' : ''); ?>>
                        ...
                        <?php else: ?>
                            ...
                            <option value="1" <?php echo e(old('event_id', $eventZone->event_id ?? 1) == 1 ? 'selected' : ''); ?>>
                                Tech Conference 2024 - Jan 15, 2024
                            </option>
                            <option value="2" <?php echo e(old('event_id', $eventZone->event_id ?? 1) == 2 ? 'selected' : ''); ?>>
                                Music Festival Summer - Jul 20, 2024
                            </option>
                            <option value="3" <?php echo e(old('event_id', $eventZone->event_id ?? 1) == 3 ? 'selected' : ''); ?>>
                ...
                <div class="mt-6">
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        placeholder="Describe the zone location, amenities, or special features..."><?php echo e(old('description', $eventZone->description ?? 'Premium seating area with exclusive access to VIP lounge and complimentary refreshments.')); ?></textarea>
                </div>
                ...
                <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex space-x-3">
                        <a href="<?php echo e(route('eventZones.show', $eventZone->id ?? 1)); ?>"
    ...
    <script>
        ...
        const currentSold = <?php echo e($eventZone->tickets_sold ?? 45); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\registration_system\resources\views/eventZone/edit.blade.php ENDPATH**/ ?>