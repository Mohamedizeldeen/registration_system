    ...
    <div class="bg-white shadow-sm">
        <div class="max-w-6xl mx-auto px-4 py-6">
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(route('currencies.create')); ?>" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition duration-200 flex items-center">
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900"><?php echo e($currency->code ?? 'USD'); ?></h3>
                                        <p class="text-sm text-gray-600"><?php echo e($currency->name ?? 'US Dollar'); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2 mb-4">
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="font-semibold"><?php echo e($currency->symbol ?? '$'); ?></span>
                                </div>
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-600">Exchange Rate:</span>
                                    <span class="font-semibold"><?php echo e($currency->exchange_rate ?? '1.00'); ?></span>
                                </div>
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-600">Status:</span>
                                    <span class="font-semibold <?php echo e(($currency->is_active ?? true) ? 'text-green-600' : 'text-red-600'); ?>">
                                        <?php echo e(($currency->is_active ?? true) ? 'Active' : 'Inactive'); ?>
                            ...
                            <div class="flex justify-between items-center">
                                <div class="text-xs text-gray-500">
                                    Created <?php echo e($currency->created_at->diffForHumans() ?? 'Recently'); ?>

                                </div>
                                
                                <div class="flex space-x-2">
                                    <a href="<?php echo e(route('currencies.show', $currency->id)); ?>" class="text-blue-600 hover:text-blue-800">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('currencies.edit', $currency->id)); ?>" class="text-yellow-600 hover:text-yellow-800">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="<?php echo e(route('currencies.destroy', $currency->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this currency?')">
                                        <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
            ...
            <div class="bg-white rounded-lg shadow-md p-12 text-center">
                ...
                <a href="<?php echo e(route('currencies.create')); ?>" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition duration-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\registration_system\resources\views/currencies/index.blade.php ENDPATH**/ ?>